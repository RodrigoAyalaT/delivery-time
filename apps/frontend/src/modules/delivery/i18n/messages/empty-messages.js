    ...
    en: {
        delivery: {
            empty: {
                ...
                contact: 'Contact details missing',
                paymentMethod: 'You must choose a payment method'
            },
        },
    },
    es: {
        delivery: {
            empty: {
                ...
                contact: 'Faltan datos de contacto',
                paymentMethod: 'Debe elegir un método de pago'
            },
