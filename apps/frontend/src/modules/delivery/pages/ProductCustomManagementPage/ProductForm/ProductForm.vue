...
import IngredientCombobox from "@/modules/delivery/components/IngredientCombobox";
import ProductCategoryCombobox from "@/modules/delivery/components/ProductCategoryCombobox";

export default {
  name: "ProductForm",
  mixins: [InputErrorsByProps, RequiredRule],
  components: {IngredientCombobox, ProductCategoryCombobox, MediaField},
  props: {
    value: {
      type: Object,
      required: true
