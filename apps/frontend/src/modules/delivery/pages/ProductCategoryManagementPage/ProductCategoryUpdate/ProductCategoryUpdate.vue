  ...
  data() {
    return {
      ...
      form: {
        id: this.item.id,
        name: this.item.name,
        backgroundColor: this.item.backgroundColor ? this.item.backgroundColor : '',
        borderColor: this.item.borderColor ? this.item.borderColor : '',
        fontColor: this.item.fontColor ? this.item.fontColor : ''
      }
    }
  },
  methods: {
